...
inputs["postcode"] = st.number_input("Zipcode :", value=None, placeholder="1000")
...
inputs["energy_consumption_kWh"] = st.number_input("Energy consumption (kWh/m2/year) :", value=150)
