...
inputs["energy_consumption_kWh"] = st.number_input("energy_consumption_kWh :", value=int)
...
inputs["nearest_city_distance_km"] = st.number_input("nearest_city_distance_km :", value=float)
